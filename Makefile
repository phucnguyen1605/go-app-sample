...
VER=dev
GCP_PROJECT_ID=kubenetes-learning-phucnh
...
docker-build-ci:
	docker build -f ./.docker/DockerfileBuild -t phucnh07/gobuild:${GO_BUILD_IMAGE_VER} .

docker-push-ci:
	docker push phucnh07/gobuild:${GO_BUILD_IMAGE_VER}
